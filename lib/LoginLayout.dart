...
class _LoginLayout extends State<LoginLayout> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      ...
      //BoxConstraints constraints : 반응형
      final double width = constraints.maxWidth;
      final double height = constraints.maxHeight;
      return Center(
        //center 대신 container column 괜찮
        child: Column(
          // column & row 만 children을 넣을 수 있음
          children: <Widget>[
            Container(
              height: width / 5,
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Image.asset('assets/images/kakao.png', width: width / 15),
                      SizedBox(
                        width: width / 20,
                      ),
                      Text(
